...
"background-color: rgb(230, 230, 230);")
        ...
        self.actionQuadViewer = QAction(MainWindow)
        self.actionQuadViewer.setObjectName(u"actionQuadViewer")
        self.actionSave_Metrics = QAction(MainWindow)
        self.actionSave_Metrics.setObjectName(u"actionSave_Metrics")
...
"")
        ...
        self.menuXYController.addAction(self.actionIIndexPlanchet)
        self.menuXYController.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionQuadViewer.setText(QCoreApplication.translate("MainWindow", u"Quad Viewer", None))
        self.actionSave_Metrics.setText(QCoreApplication.translate("MainWindow", u"Save Troubleshooting Metrics", None))
        self.actionSave_Metrics.setIconText(QCoreApplication.translate("MainWindow", u"Save Troubleshooting Metrics to CSV File (Warning File will get very big over time)", None))
#if QT_CONFIG(tooltip)
        self.actionSave_Metrics.setToolTip(QCoreApplication.translate("MainWindow", u"Save Troubleshooting Metrics to CSV File (Warning File will get very big over time)", None))
#endif // QT_CONFIG(tooltip)
