...
from ui_planchetbatch import Ui_dialogPlanchet
...
class UiPlanchet(QDialog, Ui_dialogPlanchet):
    ...
    def startup(self):
        ...
        self.comboTask1.addItems(cycle for cycle in currentcycle.cycles if cycle[0] == 'S')
        self.comboTask1.setCurrentText('Sample + Reheat')
